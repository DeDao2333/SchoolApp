...
import com.example.java.algorithm.javabean.AddFriendMessage;
...
public class UserInfoActivity extends ParentWithNaviActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initNaviView();
        //用户
        user = (_User) getBundle().getSerializable("u");
        ...
        info = new BmobIMUserInfo(user.getObjectId(), user.getNickname(), user.getAvatar());
        //加载头像
        ImageLoaderFactory.getLoader().loadAvator(iv_avator, user.getAvatar(), R.mipmap.head);
        //显示信息
        tv_name.setText(user.getNickname());
        mTvMajor.setText(user.getMajor());
    ...
    private void sendAddFriendMessage() {
        ...
        msg.setContent("你好，可以加个好友吗?");//给对方的一个留言信息
