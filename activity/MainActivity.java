...
public class MainActivity extends BaseActivity {
    ...
    private void initTab() {
        ...
        fragments = new Fragment[]{mMainPostFragment,conversationFragment,
                mCommunityFragment,setFragment};
        getSupportFragmentManager().beginTransaction()
                .add(R.id.fragment_container, mMainPostFragment)
                .add(R.id.fragment_container, conversationFragment)
                .add(R.id.fragment_container, mCommunityFragment)
                .add(R.id.fragment_container, setFragment)
                .hide(setFragment)
                .hide(conversationFragment)
                .hide(mCommunityFragment)
                .show(mMainPostFragment).commit();
    }
